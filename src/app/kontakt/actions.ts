...
export async function sendContactAction(
  ...
  <tr><td style="padding:8px 0;border-bottom:1px solid #E8EAE5;font-size:14px;color:#5A6B82;width:32%;">Name</td>
      <td style="padding:8px 0;border-bottom:1px solid #E8EAE5;font-weight:700;">${escapeHtml(input.name)}</td></tr>
  <tr><td style="padding:8px 0;border-bottom:1px solid #E8EAE5;font-size:14px;color:#5A6B82;">Mail</td>
      <td style="padding:8px 0;border-bottom:1px solid #E8EAE5;">${escapeHtml(input.email)}</td></tr>
  <tr><td style="padding:8px 0;font-size:14px;color:#5A6B82;">Telefon</td>
...
<p style="margin:0;white-space:pre-wrap;color:#5A6B82;">${escapeHtml(input.nachricht)}</p>`,
      ),
    });
  } catch (error) {
