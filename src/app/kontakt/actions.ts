...
export async function sendContactAction(
  ...
  <tr><td style="padding:8px 0;border-bottom:1px solid #EFEFEE;font-size:14px;color:#6C6C74;width:32%;">Name</td>
      <td style="padding:8px 0;border-bottom:1px solid #EFEFEE;font-weight:700;">${escapeHtml(input.name)}</td></tr>
  <tr><td style="padding:8px 0;border-bottom:1px solid #EFEFEE;font-size:14px;color:#6C6C74;">Mail</td>
      <td style="padding:8px 0;border-bottom:1px solid #EFEFEE;">${escapeHtml(input.email)}</td></tr>
  <tr><td style="padding:8px 0;font-size:14px;color:#6C6C74;">Telefon</td>
...
<p style="margin:0;white-space:pre-wrap;color:#6C6C74;">${escapeHtml(input.nachricht)}</p>`,
      ),
    });
  } catch (error) {
